        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav nav-underline ms-auto column-gap-2 pe-5">
                ...
                <li class="nav-item me-2">
                    <a class="list-group-item" href="create-order.php">
                ...
                <li class="nav-item d-flex align-items-center">
                    <a class="nav-link text-white d-flex font-14 <?php echo basename($_SERVER['PHP_SELF']) == 'index.php' ? 'active' : ''; ?>" href="index.php">
                ...
                <!-- Sale -->
                <li class="nav-item d-flex align-items-center">
                    <a class="nav-link text-white d-flex font-14 <?php echo basename($_SERVER['PHP_SELF']) == 'sales.php' ? 'active' : ''; ?>" href="sales.php">
                ...
                <!-- Products -->
                <li class="nav-item d-flex align-items-center">
                    <a class="nav-link text-white d-flex font-14 <?php echo basename($_SERVER['PHP_SELF']) == 'product.php' ? 'active' : ''; ?>" href="product.php">
            ...
            <ul class="nav fw-semibold">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-lg-end">
                        <li><a class="dropdown-item text-carbon-grey" href="accounts.php">
