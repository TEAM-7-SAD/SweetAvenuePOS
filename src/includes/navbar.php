        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto column-gap-2 pe-5">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="create-order.php">
                        <button class="btn btn-sm btn-light text-medium-brown fw-semibold px-3 py-2 d-flex align-items-center font-13">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#88531E" class="bi bi-plus-circle-fill me-2" viewBox="0 0 16 16">
                ...
                <li class="nav-item d-flex align-items-center">
                    <a class="nav-link text-white d-flex font-14" href="index.php">
                ...
                <!-- Sale -->
                <li class="nav-item d-flex align-items-center">
                    <a class="nav-link text-white d-flex font-14" href="sales.php">
                ...
                <!-- Products -->
                <li class="nav-item d-flex align-items-center">
                    <a class="nav-link text-white d-flex font-14" href="product.php">
