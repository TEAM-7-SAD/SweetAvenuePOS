          ...
          <div class="col-md-12">
            <div class="container mt-5">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <div>
                        <button type="button" class="btn btn-tiger-orange text-white me-2" data-bs-toggle="modal" data-bs-target="#addCategoryModal">Add Category</button>
                        <button type="button" class="btn btn-tiger-orange text-white me-2" data-bs-toggle="modal" data-bs-target="#addProductModal">Add Product</button>
                        <button type="button" class="btn btn-tiger-orange text-white me-2" id="editButton" data-bs-toggle="modal" data-bs-target="#editProductModal" disabled>Edit</button>
                        <button class="btn btn-danger fw-semibold px-3 py-2 delete-product" disabled>Delete</button>
                    </div>
                </div>
                          ...
                          <table id="food" class="table table-transparent">
                              ...
                              <tbody>
                                  ...
                                  while($row = $result->fetch_assoc()) {
                                      ...
                                      echo "<td class='text-carbon-grey'><input type='checkbox' class='product-checkbox' data-product-id='" . $row['id'] . "' data-variation-id='" . $row['variation_id'] . "'></td>";
                                      echo "<td class='text-carbon-grey'><img src='" . $row['Image'] . "' alt='Product Image' style='max-width: 50px; max-height: 50px; border-radius: 50%;'></td>";
